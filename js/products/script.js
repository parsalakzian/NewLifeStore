...
.then(data => {
    ...
    const product = products[productId].en;
    document.title = product.name
    // نمایش اطلاعات محصول
    document.getElementById('product-name').textContent = product.name;
    document.getElementById('product-description').textContent = product.description;
    document.getElementById('product-price').textContent = product.price + ' T';
    document.getElementById('product-stock').textContent = `Stock: ${product.stock} items`;
